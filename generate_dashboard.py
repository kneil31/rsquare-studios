...
def generate_html():
    ...
    # Client content: pricing, booking, rate config (password: ***REMOVED***)
    # Internal content: workflow, checklists, posing guides (password: ***REMOVED***)
    client_content = {}
    internal_content = {}
...
<body>
    ...
    <!-- WhatsApp floating button -->
    <a href="https://wa.me/***REDACTED_PHONE***?text=Hi%20Ram!%20I%27m%20interested%20in%20a%20photography%20session." class="wa-float" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
        ...
        <div class="content" id="main-content">
            ...
            <div class="page" id="contact">
                ...
                <div class="gallery-grid" style="max-width:400px;">
                    <a href="https://wa.me/***REDACTED_PHONE***?text=Hi%20Ram!%20I%27m%20interested%20in%20a%20photography%20session." target="_blank" rel="noopener" class="gallery-card" style="border-color:#25D366;">
                    ...
                    <a href="tel:+***REDACTED_PHONE***" class="gallery-card">
                        <div class="gallery-icon" style="font-size:28px;">📞</div>
                        <div class="gallery-info">
...
def main():
    ...
    print(f"  🔑 Internal password: ***REMOVED***\n")
